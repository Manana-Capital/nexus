 ...
 * Please refer to the module registration guidelines.：https://github.com/cipchk/ng-alain/issues/180
 */
import {
  NgModule,
  Optional,
...
export class DelonModule {
  ...
  static forRoot(): ModuleWithProviders {
    return {
      ...
      providers: [
        // TIPS：If you do not need routing multiplexing, you need to remove the following code and template.
        // `<reuse-tab></reuse-tab>`
        {
